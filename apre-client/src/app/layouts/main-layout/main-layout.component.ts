...
export class MainLayoutComponent {
  ...
  agentPerformanceReports = [
    ...
    {
      name: 'Agent Performance by Month',
      url: '/reports/agent-performance/agent-performance-by-month'
    }
    // Add more reports as needed
  ];
  ...
  customerFeedbackReports = [
    ...
    {
      name: 'Customer Feedback by Product',
      url: '/reports/customer-feedback/feedback-by-product'
    }
    // Add more reports as needed
  ];
